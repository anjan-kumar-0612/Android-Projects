...
public class setProfile extends AppCompatActivity {
        ...
        msaveprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    Intent intent=new Intent(setProfile.this, com.example.friendtalk.chatActivity.class);
    ...
    private void sendDataToRealTimeDatabase()
    {
        ...
        com.example.friendtalk.userprofile muserprofile=new com.example.friendtalk.userprofile(name,firebaseAuth.getUid());
