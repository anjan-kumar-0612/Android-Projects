        ...
        mupdateprofilebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(imagepath!=null)
                {
                    ...
                    com.example.friendtalk.userprofile muserprofile =new com.example.friendtalk.userprofile(newname,firebaseAuth.getUid());
                    ...
                    Intent intent=new Intent(UpdateProfile.this, com.example.friendtalk.chatActivity.class);
